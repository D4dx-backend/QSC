...
const Menu = (props) => {
  ...
  const [attributes] = useState([
    ...
    {
      type: "text",
      placeholder: "Sidebar Section Title",
      name: "menuGroup",
      validation: "",
      default: "",
  ...
  const [subMenuAttributes] = useState([
    ...
    {
      type: "text",
      placeholder: "Submenu Section Title",
      name: "menuGroup",
      validation: "",
      default: "",
      label: "Submenu Section Title",
      tag: true,
      required: false,
      view: true,
      add: true,
  ...
  return (
    <Container className="noshadow">
      <ListTable actions={actions} api={`menu`} itemTitle={{ name: "label", type: "text", collection: "" }} shortName={`Menu`} formMode={`double`} surfaceTheme={"district"} {...props} attributes={attributes}></ListTable>
    </Container>
  );
};
